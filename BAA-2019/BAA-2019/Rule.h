...
Rule(NS('K'), GRB_ERROR_SERIES + 12, 18,							// Недопустимая синтаксическая конструкция
...
Rule(NS('X'), GRB_ERROR_SERIES + 13, 8,								// Недопустимая синтаксическая конструкция в теле цикла/условного выражения	
